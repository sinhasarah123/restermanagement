...
class RestaurantOrderManagement:
    def __init__(self,root):
        ...
        self.menu_item={"fries meal":2,"lunch meal":2,"burger meal":3,"pizza meal":4,"cheese burger":2.5,"drinks":1}
        ...
        ttk.Label(frame,text="currency:",font=("arial",12)).grid(row=len(self.menu_item)+1,column=0,padx=10,pady=5)
